...
<div class="card mb-3">
@if ($posts[0]->image)
    <div style="max-height: 400px; overflow: hidden; display: block; margin-left: auto; margin-right: auto; width: auto;">
...
<div class="container">
    <div class="row">
        ...
        @else
            <img src="https://source.unsplash.com/500x400/?{{ $post->category->name }}" class="card-img-top" alt="..." class="card-img-top" alt="{{ $post->category->name }}">
        @endif
                <div class="card-body">
