...
<div class="col-lg-8">
    ...
    <form method="POST" action="/dashboard/pesanan" class="mb-5" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('id_pesanan') is-invalid @enderror" id="id_pesanan" name="id_pesanan" required autofocus value="{{ old('id_pesanan') }}">
          @error('id_pesanan')
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('jml_satuan') is-invalid @enderror" id="jml_satuan" name="jml_satuan" required autofocus value="{{ old('jml_satuan') }}">
            @error('jml_satuan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('tgl_masuk') is-invalid @enderror" id="tgl_masuk" name="tgl_masuk" required readonly autofocus value="{{ date('Y-m-d') }}">
            @error('tgl_masuk')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('total') is-invalid @enderror" id="total" name="total" required autofocus value="{{ old('total') }}">
            @error('total')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
